  ...
  return (
    <div className="min-h-screen bg-[#fafbfc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Gestionar Alumnos</h1>
        <p className="text-gray-500 mb-6">Administra usuarios, roles y accesos al campus.</p>
        <div className="bg-white rounded-2xl border border-gray-100 p-10 text-center text-gray-400">
          Gestor de alumnos en construcción. Vuelve pronto.
        </div>
      </div>
    </div>
  );
