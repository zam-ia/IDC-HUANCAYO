...
- Confirma el evento y los destinos habilitados en `/admin/transmisiones`.
...
- Activa solo los destinos definitivos y abre el monitoreo del relay.
...
- Si falla una red social, deshabilita únicamente ese worker o destino.
